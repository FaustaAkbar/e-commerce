    ...
    <>
      ...
      <div className="menu-sections-container">
        <section id="popular" className="makanan">
          <h2>
            Hidangan <span className="highlight">Terbaik</span> Kami
          </h2>
          <div className="section-container">
            ...
            <button className="scroll-btn left" onClick={() => scroll('left', 'popular')}>
              ❮
            </button>
            <button className="scroll-btn right" onClick={() => scroll('right', 'popular')}>
              ❯
            </button>
          </div>
        </section>
        <section id="snacks" className="makanan">
          <h2>
            <span className="highlight">Menu</span> Makanan
          </h2>
          <div className="section-container">
            <div className="dish-cards">
            ...
            <button className="scroll-btn left" onClick={() => scroll('left', 'snacks')}>
              ❮
            </button>
            <button className="scroll-btn right" onClick={() => scroll('right', 'snacks')}>
              ❯
            </button>
          </div>
        </section>
        <section id="regular" className="makanan">
          <h2>
            Menu <span className="highlight">Minuman</span> Kami
          </h2>
          <div className="section-container">
            <div className="dish-cards">
            ...
            <button className="scroll-btn left" onClick={() => scroll('left', 'regular')}>
              ❮
            </button>
            <button className="scroll-btn right" onClick={() => scroll('right', 'regular')}>
              ❯
            </button>
          </div>
        </section>
